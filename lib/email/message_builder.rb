  ...
  class MessageBuilder
    ...
    def html_part
      ...
      if @opts[:add_unsubscribe_link]
        ...
        if @template_args[:unsubscribe_url].present?
          unsubscribe_url = @template_args[:unsubscribe_url]
          unsubscribe_link = PrettyText.cook(I18n.t('unsubscribe_link', @template_args.merge(unsubscribe_url: unsubscribe_url))).html_safe
        else
          unsubscribe_link = PrettyText.cook(I18n.t('unsubscribe_link_preferences', @template_args.merge(user_preferences_url: "#{Discourse.base_url}/my/preferences"))).html_safe
        end
